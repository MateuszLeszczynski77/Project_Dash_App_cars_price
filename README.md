...
### <b>1. Project description / Opis projektu</b>
   ...
   <p>The model was built on a dataset consisting of over 200_000 car advertisements from the Polish website otomoto. / Model został zbudowany na zbiorze danych, który składa się z ponad 200       
    tysięcy ogłoszeń samochodów z polskiego serwisu otomoto.</p>
   ...
   ### <b>2. Project goal / Cel projektu</b>
   <p>The best possible prediction of used car prices. / Jak najlepsza predykcja cen samochodów używanych.</p>
   <p>Main business goals: / Główne cele biznesowe: </p>
   <li>Increase profits by better pricing of used cars. / Zwiększenie zysków poprzez lepsze określanie cen samochodów używanych. </li>
   <li>Increase market share through competitive prices. / Zwiększenie udziału w rynku poprzez konkurencyjne ceny. </li>
   <li>Data-driven refinement of pricing strategies. / Udoskonalenie strategii cenowych na podstawie danych. </li>
   
   ### <b>3. Installation-instructions / Instalacja-instrukcja</b>
   ...
   ### <b>6. Creator / Twórca</b>
   
   <p><b>Mateusz Leszczyński</b> | https://github.com/MateuszLeszczynski77</p>
   
   ### <b>7. Project status / Status projektu</b>
   
   <p>The project is in the beta phase and will be developed. / Projekt jest w fazie beta i będzie dalej rozwijany.</p>
   
   ### <b>8. A screenshot showing the web interface / Zrzut ekranu przedstawiający interfejs webowy</b>
